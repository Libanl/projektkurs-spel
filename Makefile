...
spelare: main.o zombie.o spelare.o powerup.o music.o bullet.o text.o
	gcc -o spelare main.o zombie.o spelare.o powerup.o music.o bullet.o text.o $(LDFLAGS)
...
powerup.o: ./src/powerup.c ./includes/powerup.h
	gcc -c ./src/powerup.c
